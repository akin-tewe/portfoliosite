            ...
            <section id="splash" className="w-full h-[80vh] md:justify-start md:h-[50vh] grid place-items-center md:px-[5vw]">
                <div className="flex flex-row md:gap-20 mt-auto md:mb-30 mr-[8vw] mb-[8vh] md:ml-0 w-full px-[10vw]">
                    <div className="relative flex flex-col gap-10">
                        ...
                        <p className={`${roboto.className} hidden md:block text-white font-light text-xl md:text-2xl md:max-w-2xl leading-relaxed`}>As star artists “Latto” and “Sexyy Red” were brought on to the remix of Young Nudy’s
            ...
            <section id="body" className="pb-20 md:pb-50 px-5 md:px-[11vw]">
                <div className="flex flex-col max-w-xs md:max-w-2xl gap-10">
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-xl md:text-2xl font-light leading-relaxed`}>6 short hours.
                        ...
                        <div className={` ${roboto.className} text-white/40 justify-self-center text-center mt-[0.5vw] italic`}>"Peaches and Eggplants" by Young Nudy original cover art.</div>
                        <p className={`${roboto.className} mt-10 text-white text-xl md:text-2xl font-light leading-relaxed`}>The original cover was a still-life composition built
                    ...
                    <div>
                        ...
                        <DragScroll className="flex gap-[1vw] mt-10 relative bg-white/20 p-[1vw] rounded-sm">
                            <Image
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-xl md:text-2xl font-light leading-relaxed`}>After deciding what made sense to remove, we had to figure out what made sense to include.
                        ...
                        <div className={` ${roboto.className} text-white/40 justify-self-center text-center mt-[0.5vw] italic`}>initial work in progress scene.</div>
                        <p className={`${roboto.className} mt-10 text-white text-xl md:text-2xl font-light leading-relaxed`}>Scale and placement were the two factors that provided the most friction.
                    ...
                    <div className="flex relative overflow-hidden bg-white/20 p-[1vw] rounded-sm">
                        <Image
                    ...
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-xl md:text-2xl font-light leading-relaxed`}>The final cover preserved the identity of the original release while also
