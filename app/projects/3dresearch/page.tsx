            ...
            <section id="splash" className="w-full h-[80vh] md:justify-start md:h-[50vh] grid place-items-center md:px-[5vw]">
                <div className="flex flex-row md:gap-20 mt-auto md:mb-30 mr-[8vw] mb-[8vh] md:ml-0 w-full px-[10vw]">
                    <div className="relative flex flex-col gap-10">
                        ...
                        <p className={`${roboto.className} hidden md:block text-white font-light text-2xl md:max-w-2xl leading-relaxed`}>A qualitative UX Research study exploring the nature of creative work in an
                             online economy.
                        </p>
                    </div>
            ...
            <section id="body" className="pb-20 md:pb-50 px-5 md:px-[11vw]">
                <div className="flex flex-col gap-10 max-w-xs md:max-w-2xl">
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font leading-relaxed`}>What does “freedom” actually look like for independent artists once it becomes their livelihood?</p>
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>This central question was the driving component for the entire study.
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>To answer this, interview questions were designed to feel open.
                    ...
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>Two separate interview formats were conducted to capture the picture on both a micro and macro level:</p>
                        <p className={`${pixelify.className} mt-10 text-white text-2xl font-light leading-relaxed`}>- focused, in-person interview</p>
                            <p className={`${roboto.className} mt-10 text-white text-2xl font-light pl-10 leading-relaxed`}>An extensive observational interview with visual artist “Oseanworld.”
                        ...
                        <p className={`${pixelify.className} mt-10 text-white text-2xl font-light leading-relaxed`}>- remote interview panel</p>
                            <p className={`${roboto.className} mt-10 text-white text-2xl font-light pl-10 leading-relaxed`}>A series of video calls with independent artists encompassing a broad range of
                    ...
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>Across both formats, several consistent themes emerged:</p>
                        <p className={`${pixelify.className} mt-10 text-white text-2xl font-light leading-relaxed`}>- freedom vs. stability</p>
                            <p className={`${roboto.className} mt-10 text-white text-2xl font-light pl-10 leading-relaxed`}>Artists describe the freedom provided through freelance as liberating,
                            but acknowledge unpredictability and instability of financial status.</p>
                        <p className={`${pixelify.className} mt-10 text-white text-2xl font-light leading-relaxed`}>- self-doubt vs. output</p>
                            <p className={`${roboto.className} mt-10 text-white text-2xl font-light pl-10 leading-relaxed`}>Impostor syndrome was a big theme throughout the interviews.
                        ...
                        <p className={`${pixelify.className} mt-10 text-white text-2xl font-light leading-relaxed`}>- technology: not an enemy or saviour</p>
                            <p className={`${roboto.className} mt-10 text-white text-2xl font-light pl-10 leading-relaxed`}>While Blender (a 3D creation software) is celebrated for its
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>Statements constantly juxtapose each other.
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>This framework helps to contextualize responses without reducing them to generalizations.</p>
                    </div>
                    <div>
                        <h1 className={`${pixelify.className} text-white text-3xl`}>why does it matter?</h1>

                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>This study is an anchor in human continuity.
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light pl-10 leading-relaxed`}>- Organization and utilization of large, unstructured data</p>
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light pl-10 leading-relaxed`}>- Translation of research into a coherent narrative</p>

                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>It didn’t aim to “solve a problem”, because their lives are not problems to be solved.
