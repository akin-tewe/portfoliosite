...
export default function Landing() {
  ...
  return (
    <div className="overflow-x-hidden">
      ...
      <section
        ref={heroRef}
        className="relative min-h-[50vh] md:min-h-0 md:h-[38vh] bg-gray-200 overflow-visible"
      >
        {/* Two-column content */}
        <motion.div
          initial={{ opacity: 0 }}
          ...
          className="flex flex-col md:flex-row items-center md:items-start justify-center gap-8 md:gap-[16rem] max-w-6xl mx-auto px-6 md:px-10 pt-12 md:pt-16 md:h-full relative z-10"
        >
