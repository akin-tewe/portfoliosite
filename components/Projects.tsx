                        ...
                        >
                            <div
                                ...
                                <div className={`${pixelify.className} relative grid grid-cols-1 text-gray-900 justify-center uppercase`}>
                                    ...
                                    <div className="md:text-right font-bold opacity-60 md:hidden lg:block">{/* eslint-disable-next-line @typescript-eslint/no-explicit-any */}
                                    {(project as any).subtitle}</div>
                                </div>
