...
export default function AlbumCover() {
    ...
    return (
        <main className="overflow-x-clip">
            ...
            >
                {/* Secret project banner with confetti */}
                <div className="text-center mb-8 relative">
                    <motion.span
                        initial={{ opacity: 0, scale: 0.3 }}
                        animate={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 0.5, delay: 0.4, type: "spring", stiffness: 400, damping: 12 }}
                        className={`${roboto.className} text-gray-900 bg-gray-900/10 text-sm tracking-wider rounded-full px-5 py-2 inline-flex items-center gap-2`}
                    >
                        congrats! you found a secret project <BiSolidHappyBeaming className="inline text-base" />
                    </motion.span>
                    {/* Confetti */}
                    <ConfettiPop />
                </div>
