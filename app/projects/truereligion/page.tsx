            ...
            <section id="splash" className="w-full h-[83vh] justify-center md:min-h-[95svh] grid place-items-center">
                <div className="flex flex-col md:flex-row gap-20 mt-auto mb-15 md:mb-30 mr-auto md:pl-40">
                    <div className="relative flex flex-col items-center gap-10">
                        <h1 className={`${pixelify.className} max-w-sm text-4xl md:text-5xl text-white pl-3 md:pl-0`}>true religion x “bluboy” product launch.</h1>
                ...
                <div className={`${pixelify.className} text-xl flex gap-20 text-l mt-auto justify-center`}>
                    <button
