            ...
            <section id="splash" className="w-full h-[80vh] md:justify-start md:h-[50vh] grid place-items-center md:px-[5vw]">
                <div className="flex flex-row md:gap-20 mt-auto md:mb-30 mr-[8vw] mb-[8vh] md:ml-0 w-full px-[10vw]">
                    <div className="relative flex flex-col gap-10">
                        ...
                        <p className={`${roboto.className} hidden md:block text-white font-light text-2xl md:max-w-2xl leading-relaxed`}>As star artists “Latto” and “Sexyy Red” were brought on to the remix of Young Nudy’s
            ...
            <section id="body" className="pb-20 md:pb-50 px-5 md:px-[11vw]">
                <div className="flex flex-col max-w-xs md:max-w-2xl gap-10">
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>6 short hours.
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>The original cover was a still-life composition built
                    ...
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>After deciding what made sense to remove, we had to figure out what made sense to include.
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>Scale and placement were the two factors that provided the most friction.
                    ...
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>The final cover preserved the identity of the original release while also
