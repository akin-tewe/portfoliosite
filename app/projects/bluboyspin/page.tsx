            ...
            <section id="splash" className="w-full h-[80vh] md:justify-start md:h-[50vh] grid place-items-center md:px-[5vw]">
                <div className="flex flex-row md:gap-20 mt-auto md:mb-30 mr-[8vw] mb-[8vh] md:ml-0 w-full px-[10vw]">
                    <div className="relative flex flex-col gap-10">
                        ...
                        <p className={`${roboto.className} hidden md:block text-white font-light text-2xl md:max-w-2xl leading-relaxed`}>A short-form commercial created to introduce 
            ...
            <section id="body" className="pb-20 md:pb-50 px-5 md:px-[11vw]">
                <div className="flex flex-col gap-10 max-w-xs md:max-w-2xl">
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>Bluboy is an individual I’ve done a number of works for in the past.
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>While character-driven imagery is a focal point of his overall narrative,
                    ...
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>With the characters taking a backseat, the paintings had to absorb the magic.
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>Breathing life into the paintings was the most fun part of this process.
                    ...
                    <div>
                        ...
                        <p className={`${roboto.className} mt-10 text-white text-2xl font-light leading-relaxed`}>The final piece reads less like an advertisement and more like a visual gesture.
